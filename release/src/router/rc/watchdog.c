	...
	if (nvram_match("btn_ez_mode", "1"))
	{
		...
		if (BTN_pressed_count > WPS_LED_WAIT_COUNT && LED_status_changed == 0) {
			...
			if (LED_status_on) {
				TRACE_PT("LED turn to normal\n");
				led_control(LED_POWER, LED_ON);
#if defined(RTAC65U) || defined(RTAC85U) || defined(RTAC85P) || defined(RTN800HP) || defined(RTACRH26) || defined(RTNEWIFI2) || defined(RTNEWIFI3) || defined(RTHIWIFI4) || defined(RTE8820S) || defined(RTAC101)
