...
export ac_prefix := /home/duong/AsusWRT-MT7621/release/src/router/asusnatnl/pjproject-1.12/_inst
...
export PJDIR := /home/duong/AsusWRT-MT7621/release/src/router/asusnatnl/pjproject-1.12
export APP_CC := mipsel-uclibc-gcc
export APP_CXX := mipsel-uclibc-g++
export APP_CFLAGS := -DPJ_AUTOCONF=1\
	-I/home/duong/AsusWRT-MT7621/release/src-ra-5010/router/openssl/include  -g -O2 -fPIC -DROUTER=1  -DPJ_IS_BIG_ENDIAN=0 -DPJ_IS_LITTLE_ENDIAN=1\
...
export APP_LDFLAGS := -L$(PJDIR)/pjlib/lib\
	...
	-L/home/duong/AsusWRT-MT7621/release/src-ra-5010/router/openssl    -L/home/duong/AsusWRT-MT7621/tools/brcm/K26/hndtools-mipsel-uclibc-4.2.4/lib  -ldl -lc -lgcc_s
...
export PJ_INSTALL_DIR := /home/duong/AsusWRT-MT7621/release/src/router/asusnatnl/pjproject-1.12/_inst
export PJ_INSTALL_INC_DIR := $(PJ_INSTALL_DIR)/include
export PJ_INSTALL_LIB_DIR := $(PJ_INSTALL_DIR)/lib
export PJ_INSTALL_CFLAGS := -I$(PJ_INSTALL_INC_DIR) -DPJ_AUTOCONF=1	-I/home/duong/AsusWRT-MT7621/release/src-ra-5010/router/openssl/include  -g -O2 -fPIC -DROUTER=1  -DPJ_IS_BIG_ENDIAN=0 -DPJ_IS_LITTLE_ENDIAN=1
