...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--enable-cross-compile --arch=mips --target_os=linux --cross-prefix=mipsel-uclibc- --enable-gpl --disable-static --enable-shared --enable-small --disable-runtime-cpudetect --disable-mipsfpu --disable-mipsdsp --disable-mipsdspr2 --disable-programs --disable-doc --disable-avdevice --disable-swresample --disable-swscale --disable-postproc --disable-avfilter --enable-pthreads --disable-network --disable-encoders --disable-decoders --enable-decoder=aac --enable-decoder=ac3 --enable-decoder=atrac3 --enable-decoder=h264 --enable-decoder=jpegls --enable-decoder=mp3 --enable-decoder=mpeg1video --enable-decoder=mpeg2video --enable-decoder=mpeg4 --enable-decoder=mpegvideo --enable-decoder=png --enable-decoder=wmav1 --enable-decoder=wmav2 --disable-hwaccels --disable-muxers --enable-demuxers --disable-demuxer=aa --disable-demuxer=acm --disable-demuxer=act --disable-demuxer=adf --disable-demuxer=adp --disable-demuxer=ads --disable-demuxer=adx --disable-demuxer=afc --disable-demuxer=aix --disable-demuxer=amr --disable-demuxer=amrnb --disable-demuxer=amrwb --disable-demuxer=apc --disable-demuxer=ape --disable-demuxer=apng --disable-demuxer=aptx --disable-demuxer=aptx_hd --disable-demuxer=aqtitle --disable-demuxer=asf_o --disable-demuxer=ass --disable-demuxer=ast --disable-demuxer=avr --disable-demuxer=bethsoftvid --disable-demuxer=bfi --disable-demuxer=bfstm --disable-demuxer=bit --disable-demuxer=bmv --disable-demuxer=boa --disable-demuxer=brstm --disable-demuxer=c93 --disable-demuxer=cdxl --disable-demuxer=cine --disable-demuxer=codec2 --disable-demuxer=codec2raw --disable-demuxer=concat --disable-demuxer=data --disable-demuxer=daud --disable-demuxer=dcstr --disable-demuxer=dfa --disable-demuxer=dirac --disable-demuxer=dnxhd --disable-demuxer=dsf --disable-demuxer=dsicin --disable-demuxer=dss --disable-demuxer=dtshd --disable-demuxer=dvbsub --disable-demuxer=dvbtxt --disable-demuxer=dxa --disable-demuxer=epaf --disable-demuxer=ffmetadata --disable-demuxer=fits --disable-demuxer=frm --disable-demuxer=fsb --disable-demuxer=g722 --disable-demuxer=g723_1 --disable-demuxer=g726 --disable-demuxer=g726le --disable-demuxer=g729 --disable-demuxer=gdv --disable-demuxer=genh --disable-demuxer=gif --disable-demuxer=gsm --disable-demuxer=gxf --disable-demuxer=hevc --disable-demuxer=hls --disable-demuxer=hnm --disable-demuxer=ico --disable-demuxer=idcin --disable-demuxer=idf --disable-demuxer=iff --disable-demuxer=ilbc --disable-demuxer=image2 --disable-demuxer=image2pipe --disable-demuxer=image_bmp_pipe --disable-demuxer=image_dds_pipe --disable-demuxer=image_dpx_pipe --disable-demuxer=image_exr_pipe --disable-demuxer=image_j2k_pipe --disable-demuxer=image_jpeg_pipe --disable-demuxer=image_jpegls_pipe --disable-demuxer=image_pam_pipe --disable-demuxer=image_pbm_pipe --disable-demuxer=image_pcx_pipe --disable-demuxer=image_pgm_pipe --disable-demuxer=image_pgmyuv_pipe --disable-demuxer=image_pictor_pipe --disable-demuxer=image_png_pipe --disable-demuxer=image_ppm_pipe --disable-demuxer=image_psd_pipe --disable-demuxer=image_qdraw_pipe --disable-demuxer=image_sgi_pipe --disable-demuxer=image_sunrast_pipe --disable-demuxer=image_svg_pipe --disable-demuxer=image_tiff_pipe --disable-demuxer=image_webp_pipe --disable-demuxer=image_xpm_pipe --disable-demuxer=ingenient --disable-demuxer=ipmovie --disable-demuxer=ircam --disable-demuxer=ivf --disable-demuxer=ivr --disable-demuxer=jacosub --disable-demuxer=jv --disable-demuxer=live_flv --disable-demuxer=lmlm4 --disable-demuxer=loas --disable-demuxer=lrc --disable-demuxer=lvf --disable-demuxer=lxf --disable-demuxer=mgsts --disable-demuxer=microdvd --disable-demuxer=mjpeg_2000 --disable-demuxer=mlv --disable-demuxer=mm --disable-demuxer=mmf --disable-demuxer=mpjpeg --disable-demuxer=mpl2 --disable-demuxer=mpsub --disable-demuxer=msf --disable-demuxer=msnwc_tcp --disable-demuxer=mtaf --disable-demuxer=mtv --disable-demuxer=musx --disable-demuxer=mv --disable-demuxer=mxf --disable-demuxer=mxg --disable-demuxer=nistsphere --disable-demuxer=nsp --disable-demuxer=nsv --disable-demuxer=nut --disable-demuxer=oma --disable-demuxer=paf --disable-demuxer=pjs --disable-demuxer=pmp --disable-demuxer=pva --disable-demuxer=pvf --disable-demuxer=rawvideo --disable-demuxer=realtext --disable-demuxer=redspark --disable-demuxer=rl2 --disable-demuxer=roq --disable-demuxer=rpl --disable-demuxer=rsd --disable-demuxer=rso --disable-demuxer=s337m --disable-demuxer=sami --disable-demuxer=sbc --disable-demuxer=sbg --disable-demuxer=scc --disable-demuxer=sdr2 --disable-demuxer=sds --disable-demuxer=sdx --disable-demuxer=segafilm --disable-demuxer=shorten --disable-demuxer=siff --disable-demuxer=sln --disable-demuxer=smacker --disable-demuxer=smjpeg --disable-demuxer=smush --disable-demuxer=sol --disable-demuxer=spdif --disable-demuxer=srt --disable-demuxer=stl --disable-demuxer=str --disable-demuxer=subviewer --disable-demuxer=subviewer1 --disable-demuxer=sup --disable-demuxer=svag --disable-demuxer=tak --disable-demuxer=tedcaptions --disable-demuxer=thp --disable-demuxer=threedostr --disable-demuxer=tiertexseq --disable-demuxer=tta --disable-demuxer=tty --disable-demuxer=txd --disable-demuxer=ty --disable-demuxer=v210 --disable-demuxer=v210x --disable-demuxer=vag --disable-demuxer=vivo --disable-demuxer=vmd --disable-demuxer=vobsub --disable-demuxer=voc --disable-demuxer=vpk --disable-demuxer=vplayer --disable-demuxer=wc3 --disable-demuxer=webm_dash_manifest --disable-demuxer=webvtt --disable-demuxer=wsaud --disable-demuxer=wsd --disable-demuxer=wsvqa --disable-demuxer=wtv --disable-demuxer=wve --disable-demuxer=xa --disable-demuxer=xbin --disable-demuxer=xmv --disable-demuxer=xvag --disable-demuxer=xwma --disable-demuxer=yuv4mpegpipe --disable-parsers --enable-parser=aac --enable-parser=ac3 --enable-parser=h264 --enable-parser=mpeg4video --enable-parser=mpegaudio --enable-parser=mpegvideo --disable-bsfs --disable-protocols --enable-protocol=file --disable-devices --disable-filters --extra-cflags='-Os  -ffunction-sections -fdata-sections -fPIC ' --extra-ldflags='-ffunction-sections -fdata-sections -Wl,--gc-sections -fPIC' --disable-zlib --disable-debug --prefix=
prefix=/usr/local
...
OBJCC=mipsel-uclibc-gcc
LD=mipsel-uclibc-gcc
DEPCC=mipsel-uclibc-gcc
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=mipsel-uclibc-gcc
DEPASFLAGS= $(CPPFLAGS)
X86ASM=nasm
DEPX86ASM=nasm
...
ARFLAGS=rcD
AR_O=$@
AR_CMD=mipsel-uclibc-ar
NM_CMD=mipsel-uclibc-nm -g
...
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -D_POSIX_C_SOURCE=200112 -D_XOPEN_SOURCE=600 -DPIC -I$(SRC_PATH)/compat/atomics/pthread
CFLAGS=-DRTAC101 -DRTAC101 -DRTAC101 -DRTAC101 -D__CONFIG_EMF__ -D__CONFIG_WPS__  -Os -ffunction-sections -fdata-sections -fPIC -std=c99 -fomit-frame-pointer -fPIC -mips32r2 -pthread -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Os -fno-math-errno -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Wformat
CXXFLAGS=  -D__STDC_CONSTANT_MACROS
OBJCFLAGS=  
ASFLAGS=  -Os -ffunction-sections -fdata-sections -fPIC -fPIC -mips32r2
...
LD_PATH=-L
DLLTOOL=
WINDRES=mipsel-uclibc-windres
DEPWINDRES=mipsel-uclibc-gcc
DOXYGEN=doxygen
LDFLAGS=-ldl -ffunction-sections -fdata-sections -Wl,--gc-sections -fPIC  -mips32r2 -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
LDEXEFLAGS=
LDSOFLAGS=
...
EXTRALIBS=
COMPAT_OBJS= atomics/pthread/stdatomic.o
INSTALL=install
LIBTARGET=
